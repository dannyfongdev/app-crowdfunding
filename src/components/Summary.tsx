...
export default function Summary({ totalPledgeAmount, totalBackers}: SummaryProps): JSX.Element {
  return (
    <div className={styles.container}>
      <div className={styles.big}>${totalPledgeAmount.toLocaleString('en-us')}</div>
